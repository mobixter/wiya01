<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageTelefono.aspx.cs" Inherits="ContentAdmin.PageTelefono" %>
...
<body>
    <a href="PageDevices.aspx">Handset Compatibles</a>
    ...
    <div align="center">
        <div  align="left" style="width: 60%">
            <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" AllowSorting="True"
                ...
                CellSpacing="0" OnItemCommand="RadGrid1_ItemCommand" Skin="Simple">
                <ExportSettings HideStructureColumns="true" />
                <MasterTableView TableLayout="Fixed" DataKeyNames="handsetId" EditMode="PopUp" CommandItemDisplay="None" >
                    ...
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="handsetId" DataField="handsetId" HeaderText="Id"
                            ReadOnly="True" HeaderStyle-Width="10%" FilterControlWidth="40px" DataType="System.Int64">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="handsetName" DataField="handsetName" HeaderText="Name"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="handsetStrId" DataField="handsetStrId" HeaderText="StrId"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <custom:FilteringColumn DataField="manufacturerName" FilterControlWidth="180px" HeaderText="Manufacturer">
                            <ItemTemplate>
