<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageCategoria.aspx.cs" Inherits="ContentAdmin.PageCategoria" %>
    ...
    <div align="center">
        <div  align="left" style="width: 60%">
            <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" AllowSorting="True"
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="categoryId" EditMode="PopUp" CommandItemDisplay="Top" >
                    ...
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="categoryId" DataField="categoryId" HeaderText="Id"
                            ReadOnly="True" HeaderStyle-Width="10%" FilterControlWidth="40px" DataType="System.Int64">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="categoryNameSp" DataField="categoryNameSp" HeaderText="Spanish Name"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="categoryNameEn" DataField="categoryNameEn" HeaderText="English Name"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="categoryNamePo" DataField="categoryNamePo" HeaderText="Portuguese Name"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings UserControlName="../Controls/Forms/ctrCategoria.ascx" EditFormType="WebUserControl">
