<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageProveedor.aspx.cs" Inherits="ContentAdmin.PageProveedor" %>
    ...
    <div align="center">
        <div  align="left" style="width: 60%">
            <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" AllowSorting="True"
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="providerId" EditMode="PopUp" CommandItemDisplay="Top" >
...
<ExpandCollapseColumn Visible="True" FilterControlAltText="Filter ExpandColumn column"></ExpandCollapseColumn>
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="providerId" DataField="providerId" HeaderText="Id"
                            ReadOnly="True" HeaderStyle-Width="10%" FilterControlWidth="40px" DataType="System.Int64">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="providerName" DataField="providerName" HeaderText="Name"
                            FilterControlWidth="100px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="providerContactName" DataField="providerContactName" HeaderText="Contact Name"
                            FilterControlWidth="100px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="providerPhone" DataField="providerPhone" HeaderText="Phone"
                            FilterControlWidth="100px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="providerEmail" DataField="providerEmail" HeaderText="Email"
                            FilterControlWidth="100px" DataType="System.String">
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="provproviderLocatoriderEmail" 
                            DataField="providerLocator" HeaderText="Code"
                            FilterControlWidth="100px" DataType="System.String" 
                            FilterControlAltText="Filter provproviderLocatoriderEmail column">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings UserControlName="../Controls/Forms/ctrProveedor.ascx" EditFormType="WebUserControl">
