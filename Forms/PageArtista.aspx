<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageArtista.aspx.cs" Inherits="ContentAdmin.PageArtista" Trace="false" %>
...
<body>
    ...
    <div id="botonExportar">
        <asp:LinkButton ID="lnkExportar" runat="server" onclick="lnkExportar_Click">Export to excel</asp:LinkButton>
    </div>
    <div align="center">
        <div  align="left" style="width: 60%">
            <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" AllowSorting="True"
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="artistId" EditMode="PopUp" CommandItemDisplay="Top" >
                    ...
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="artistId" DataField="artistId" HeaderText="Id"
                            ReadOnly="True" HeaderStyle-Width="10%" FilterControlWidth="40px" DataType="System.Int64">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="artistName" DataField="artistName" HeaderText="Name"
                            FilterControlWidth="180px" DataType="System.String">
                        </telerik:GridBoundColumn>
                    </Columns>
                    <EditFormSettings UserControlName="../Controls/Forms/ctrArtista.ascx" EditFormType="WebUserControl">
