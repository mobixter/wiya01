<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="PageTipoItem.aspx.cs" Inherits="ContentAdmin.PageTipoItem" %>
    ...
    <div align="center">
        <div  align="left" style="width: 60%">
            <telerik:RadGrid ID="RadGrid1" ShowStatusBar="True" AllowSorting="True"
                ...
                <MasterTableView TableLayout="Fixed" DataKeyNames="contentTypeId" EditMode="PopUp" CommandItemDisplay="None" >
                    ...
                    <Columns>
                        <telerik:GridBoundColumn UniqueName="contentTypeId" DataField="contentTypeId" HeaderText="Id"
                            ReadOnly="True" HeaderStyle-Width="10%" FilterControlWidth="40px" DataType="System.Int64">
                            <HeaderStyle Width="10%"></HeaderStyle>
                        </telerik:GridBoundColumn>
                        <telerik:GridBoundColumn UniqueName="contentTypeName" DataField="contentTypeName" HeaderText="Name"
